...
<head>
  ...
  <link rel="stylesheet" href="assets/css/master-customer-service.css">
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-body">
          <form action="customer-service.html#" class="form-search">
  ...
  <header class="header-area style-1 pos-abs zi-9">
    <div id="elementToRemove" class="offer-note">
      <p class="text">All plans have <span>30% OFF</span> For this week <span><a href="contact.html">Claim
            Discount</a></span></p>
      <button id="removeButton" class="close-offer"><img src="assets/imgs/icon/cross-light.webp"
    ...
    <div class="container">
      <div class="header-area__inner">
        <div class="header__logo">
          <a href="index.html">
            <img src="assets/imgs/logo/logo-7.webp" class="normal-logo" alt="Site Logo">
          ...
          <nav class="main-menu">
            <ul>
              ...
              <li class="menu-item-has-children">
                <a href="customer-service.html#">Pages</a>
                <ul class="dp-menu">
                  <li><a href="integration.html">integration</a></li>
                  <li><a href="integration-single.html">integration single</a></li>
                  <li><a href="about.html">about</a></li>
              ...
              <li>
                <a href="customer-service.html#">blog</a>
                <ul class="dp-menu">
        ...
        <div class="header__button">
          <a href="javascript:void(0)" class="wc-btn wc-btn-primary btn-text-flip bordered" data-bs-toggle="modal"
              ...
              <div class="hero-area-inner">
                <div class="section-content">
                  ...
                  <div class="form-wrapper has_fade_anim" data-delay="0.45">
                    <form action="customer-service.html#" class="subscribe-form">
                  ...
                  <div class="feature-list has_fade_anim" data-delay="0.60">
                    <ul>
                      ...
                      <li><img src="assets/imgs/icon/check-3.webp" alt="icon image">14 days free trial</li>
                    </ul>
                  </div>
                </div>
                <div class="hero-thumb">
                  <div class="img-1">
                    <img src="assets/imgs/gallery/img-s-22.webp" alt="gallery image">
                  </div>
                  <div class="img-2">
                    <img src="assets/imgs/gallery/img-s-23.webp" alt="gallery image">
                  </div>
                  <div class="img-3">
                    <img src="assets/imgs/gallery/img-s-24.webp" data-speed="0.85" alt="gallery image">
                  </div>
                  <div class="img-4">
                    <img src="assets/imgs/gallery/img-s-25.webp" data-speed="1.15" alt="gallery image">
                  </div>
                  <div class="shape-1">
                    <img src="assets/imgs/shape/shape-s-20.webp" alt="shape image">
                  </div>
                  <div class="shape-2">
                    <img src="assets/imgs/shape/shape-s-21.webp" alt="shape image">
                  </div>
                  <div class="shape-3">
                    <img src="assets/imgs/shape/shape-s-22.webp" alt="shape image">
                  </div>
                  <div class="shape-4">
                    <img src="assets/imgs/shape/shape-s-23.webp" alt="shape image">
                  </div>
                  <div class="shape-5">
                    <img src="assets/imgs/shape/shape-s-24.webp" alt="shape image">
                  </div>
                </div>
              </div>
            </div>
          ...
          <section class="advantage-area section-spacing pb-0">
            <div class="container">
              <div class="advantage-area-inner">
                <div class="shape-1">
                  <img src="assets/imgs/shape/shape-s-25.webp" data-speed="0.8" alt="shape image">
                </div>
                <div class="shape-2">
                  <img src="assets/imgs/shape/shape-s-26.webp" data-speed="0.8" alt="shape image">
                </div>
                <div class="shape-3">
                  <img src="assets/imgs/shape/shape-s-27.webp" data-speed="0.8" alt="shape image">
                </div>
                      ...
                      <ul class="nav nav-tabs has_fade_anim" id="myTab" role="tablist">
                        <li class="nav-item" role="presentation">
                          <div class="nav-link active" id="home-tab" data-bs-toggle="tab"
                            ...
                            <div class="advantage-card">
                              <div class="card-icon">
                                <img src="assets/imgs/icon/icon-s-12.webp" alt="icon image">
                              </div>
                              <div class="card-text">
                        ...
                        <li class="nav-item" role="presentation">
                          <div class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile-tab-pane"
                            ...
                            <div class="advantage-card">
                              <div class="card-icon">
                                <img src="assets/imgs/icon/icon-s-13.webp" alt="icon image">
                              </div>
                              <div class="card-text">
                        ...
                        <li class="nav-item" role="presentation">
                          <div class="nav-link" id="contact-tab" data-bs-toggle="tab" data-bs-target="#contact-tab-pane"
                            ...
                            <div class="advantage-card">
                              <div class="card-icon">
                                <img src="assets/imgs/icon/icon-s-14.webp" alt="icon image">
                              </div>
                              <div class="card-text">
                        ...
                        <div class="tab-pane fade show active" id="home-tab-pane" role="tabpanel"
                          ...
                          <div class="advantage-card-content">
                            <div class="advantage-thumb">
                              <img src="assets/imgs/gallery/img-s-26.webp" alt="gallery image">
                            </div>
                      ...
                      <a href="customer-service.html#">
                        <div class="choose-card-box">
                          ...
                          <div class="thumb-wrapper">
                            <img src="assets/imgs/icon/icon-s-15.webp" alt="">
                          </div>
                        </div>
                      </a>
                    </div>
                    <div class="has_fade_anim">
                      <a href="customer-service.html#">
                        <div class="choose-card-box">
                          ...
                          <div class="thumb-wrapper">
                            <img src="assets/imgs/icon/icon-s-16.webp" alt="">
                          </div>
                        </div>
                      </a>
                    </div>
                    <div class="has_fade_anim">
                      <a href="customer-service.html#">
                        <div class="choose-card-box">
                          ...
                          <div class="thumb-wrapper">
                            <img src="assets/imgs/icon/icon-s-17.webp" alt="">
                          </div>
                        </div>
                      </a>
                    </div>
          ...
          <section class="feature-area section-spacing">
            <div class="container">
              <div class="feature-area-inner">
                <div class="shape-1">
                  <img src="assets/imgs/shape/shape-s-29.webp" data-speed="1.2" alt="shape image">
                </div>
                <div class="feature-thumb-wrapper">
                  <div class="feature-thumb">
                    <div class="main-image">
                      <img src="https://crowdytheme.com/html/saasly/assets/imgs/gallery/img-s-27.webp" alt="gallery image">
                    </div>
                    <div class="image-2">
                      <img src="assets/imgs/gallery/img-s-28.webp"  alt="gallery image">
                    </div>
                    <div class="image-3">
                      <img src="assets/imgs/gallery/img-s-29.webp" data-speed="0.8" alt="gallery image">
                    </div>
                  </div>
                </div>
                <div class="section-content">
                  ...
                  <div class="feature-list-box has_fade_anim">
                    <div class="feature-list">
                      <div class="feature-list-item">
                        <span class="icon">
                          <img src="assets/imgs/icon/check-6.webp" alt="icon image">
                        </span>
                ...
                <div class="ratings-wrapper-box">
                  <div class="ratings-wrapper has_fade_anim">
                    <div class="rating-image">
                      <img src="assets/imgs/gallery/img-s-30.webp" alt="rating image">
                    </div>
                    <div class="rating-image">
                      <img src="assets/imgs/gallery/img-s-31.webp" alt="rating image">
                    </div>
                    <div class="rating-image">
                      <img src="assets/imgs/gallery/img-s-32.webp" alt="rating image">
                    </div>
                  </div>
                </div>
              </div>
          ...
          <section class="faq-area section-spacing pb-0">
            <div class="container">
              <div class="faq-area-inner">
                ...
                <div class="faq-thumb">
                  <img src="assets/imgs/gallery/img-s-33.webp" alt="gallery image">
                </div>
              </div>
            </div>
          </section>
          ...
          <section class="pricing-area section-spacing">
            <div class="container">
              <div class="pricing-area-inner">
                <div class="shape-1">
                  <img src="assets/imgs/shape/shape-s-30.webp" data-speed="0.8" alt="shape image">
                </div>
                <div class="section-header">
                  <div class="section-title-wrapper">
                    <div class="title-wrapper">
          ...
          <section class="integration-area section-spacing">
            <div class="container">
              <div class="integration-area-inner">
                <div class="shape-1">
                  <img src="assets/imgs/shape/shape-s-31.webp" alt="shape image">
                </div>
                <div class="section-header">
                  <div class="section-title-wrapper">
                    <div class="title-wrapper">
            ...
            <div class="footer-area-inner">
              <div class="footer-widget-wrapper">
                <div class="footer-logo">
                  <img src="assets/imgs/logo/logo-8.webp" alt="site-logo">
                </div>
              ...
              <div class="footer-widget-wrapper">
                ...
                <ul class="footer-nav-list">
                  <li><a href="customer-service.html#">About</a></li>
                  <li><a href="customer-service.html#">Careers</a></li>
                  <li><a href="customer-service.html#">Press</a></li>
                  <li><a href="customer-service.html#">Contact Us</a></li>
                  <li><a href="customer-service.html#">System Status</a></li>
                </ul>
              </div>
              <div class="footer-widget-wrapper">
                <h2 class="title">Useful Link</h2>
                <ul class="footer-nav-list">
                  <li><a href="customer-service.html#">Features</a></li>
                  <li><a href="customer-service.html#">Resources</a></li>
                  <li><a href="customer-service.html#">Service</a></li>
                  <li><a href="customer-service.html#">Team</a></li>
                  <li><a href="customer-service.html#">Collection</a></li>
                </ul>
              </div>
              <div class="footer-widget-wrapper">
                <h2 class="title">Product</h2>
                <ul class="footer-nav-list">
                  <li><a href="customer-service.html#">Live Chat</a></li>
                  <li><a href="customer-service.html#">Jirogram</a></li>
                  <li><a href="customer-service.html#">Datasetico</a></li>
                  <li><a href="customer-service.html#">Underline</a></li>
                  <li><a href="customer-service.html#">Keyword</a></li>
                </ul>
              </div>
            </div>
            <div class="copyright-area-inner">
              <ul class="social-links">
                <li><a href="customer-service.html#"><i class="fa-brands fa-facebook-f"></i></a></li>
                <li><a href="customer-service.html#"><i class="fa-brands fa-twitter"></i></a></li>
                <li><a href="customer-service.html#"><i class="fa-brands fa-instagram"></i></a></li>
                <li><a href="customer-service.html#"><i class="fa-brands fa-linkedin"></i></a></li>
              </ul>
        ...
        <div class="form-box-wrapper">
          <div class="login-form-box">
            ...
            <div class="form-wrapper">
              <form action="customer-service.html#" class="user-form">
                <div class="input-field">
                  <input type="email" placeholder="Enter your email">
                </div>
                <div class="input-field">
                ...
                <div class="policy-field">
                  ...
                  <a href="customer-service.html#" class="forget-password">Forgot your password?</a>
                </div>
                <button type="submit" class="subscribe-btn wc-btn-primary btn-text-flip"><span
            ...
            <div class="form-wrapper">
              <form action="customer-service.html#" class="user-form">
                ...
                <div class="policy-field">
                  ...
                  <label for="d-policy">I agree to sassly <span><a href="customer-service.html#">Terms of Service.</a></span></label>
                </div>
                <button type="submit" class="subscribe-btn wc-btn-primary btn-text-flip"><span
