...
<head>
  ...
  <title>Sassly Privacy Policy</title>
  ...
  <link rel="stylesheet" href="assets/css/master-privacy-policy.css">
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-body">
          <form action="privacy-policy.html#" class="form-search">
          ...
          <nav class="main-menu">
            <ul>
              ...
              <li class="menu-item-has-children">
                <a href="privacy-policy.html#">Pages</a>
                <ul class="dp-menu">
                  <li><a href="integration.html">integration</a></li>
                  <li><a href="integration-single.html">integration single</a></li>
                  <li><a href="about.html">about</a></li>
    ...
    <div id="smooth-content">
      <div class="body-wrapper body-booking">
        ...
        <main>
                ...
                <div class="section-header">
                  <div class="section-title-wrapper">
                    <div class="title-wrapper">
                      <h1 class="section-title large has_fade_anim">Our privacy
                        policy</h1>
                    </div>
                  </div>
                  <div class="shape has_fade_anim" data-delay="0.30" data-fade-from="left">
                    <img src="assets/imgs/shape/shape-s-56.webp" alt="shape image">
                  </div>
          ...
          <!-- policy area start  -->
          <div class="policy-area section-spacing pt-0 pin__area">
            <div class="container">
              <div class="policy-wrapper">
                <nav class="pin__element">
                  <ul class="nav nav-pills mb-3 has_fade_anim" id="pills-tab" role="tablist">
                    <li class="nav-item" role="presentation">
                      <button class="nav-link" id="pills-first-tab" data-bs-toggle="pill" data-bs-target="#pills-first"
                        type="button" role="tab" aria-controls="pills-first" aria-selected="true">Data
                        controller</button>
                    </li>
                    <li class="nav-item" role="presentation">
                      <button class="nav-link active" id="pills-second-tab" data-bs-toggle="pill"
                    ...
                    <li class="nav-item" role="presentation">
                      <button class="nav-link" id="pills-third-tab" data-bs-toggle="pill" data-bs-target="#pills-third"
                        type="button" role="tab" aria-controls="pills-third" aria-selected="false">Data update</button>
                    </li>
                    <li class="nav-item" role="presentation">
                      <button class="nav-link" id="pills-fourth-tab" data-bs-toggle="pill"
                        ...
                        aria-selected="false">Disclosure of
                        data</button>
                    </li>
                    <li class="nav-item" role="presentation">
                      <button class="nav-link" id="pills-fifth-tab" data-bs-toggle="pill" data-bs-target="#pills-fifth"
                        type="button" role="tab" aria-controls="pills-fifth" aria-selected="false">Rights of the
                        user</button>
                    </li>
                    <li class="nav-item" role="presentation">
                      <button class="nav-link" id="pills-sixth-tab" data-bs-toggle="pill" data-bs-target="#pills-sixth"
                        type="button" role="tab" aria-controls="pills-sixth" aria-selected="false">Data
                        security</button>
                    </li>
                  </ul>
                </nav>
                <div class="tab-content" id="pills-tabContent">
                  <div class="tab-pane fade" id="pills-first" role="tabpanel" aria-labelledby="pills-first-tab"
                    ...
                    <div class="policy-content">
                      <h2 class="section-title large">Digital services Update February 2024</h2>
                      <div class="text-wrapper">
                        <p class="text">Below is a suggested outlines for a privacy policy for a Software as a Service
                          (SaaS) company. keep in mind that privacy policies should be customized to reflect the
                          specific practices and policies of your company, as well as any applicable laws and
                          regulations. It's also recommended to have legal counsel review your privacy policy to ensure
                          compliance.</p>
                        <p class="text">We take reasonable measures to protect the security of your personal information
                          and prevent unauthorized access, use, or disclosure. however, please be aware that no method
                      ...
                      <div class="text-wrapper">
                        <p class="text">You have certain rights regarding your personal information, including the right
                          to access, update and delete your information. You may also have the right to restrict or
                          object to certain processing activities. to exercise these rights, please contact us using the
                          contact information provided below.</p>
                      </div>
                      <h2 class="section-title">Changes to this Privacy Policy</h2>
                      <div class="text-wrapper">
                        <p class="text">We may update this Privacy Policy from time to time to reflect changes in our
                          practices or applicable laws. We will notify you of any material changes by posting the
                          updated Privacy Policy on our website.</p>
                      </div>
                      <h2 class="section-title">Contact Us</h2>
                      <div class="text-wrapper">
                        <p class="text">If you have any questions or concerns about this Privacy Policy or our data
                          practices, please contact us at [contact email or address].</p>
                      </div>
                      <h2 class="section-title">Effective Date</h2>
                      <div class="text-wrapper">
                        <p class="text">This Privacy Policy is effective as of [date].</p>
                      </div>
                    </div>
                  </div>
                  <div class="tab-pane fade show active" id="pills-second" role="tabpanel"
                    aria-labelledby="pills-second-tab" tabindex="0">
                    <div class="policy-content has_fade_anim">
                      <h2 class="section-title large">Digital services Update February 2024</h2>
                      <div class="text-wrapper">
                        <p class="text">Below is a suggested outlines for a privacy policy for a Software as a Service
                          (SaaS) company. keep in mind that privacy policies should be customized to reflect the
            ...
            <div class="footer-area-inner">
              ...
              <div class="footer-widget-wrapper">
                ...
                <ul class="footer-nav-list">
                  ...
                  <li><a href="privacy-policy.html#">Careers</a></li>
                  <li><a href="privacy-policy.html#">Press</a></li>
                  <li><a href="privacy-policy.html#">Contact Us</a></li>
                  <li><a href="privacy-policy.html#">System Status</a></li>
                </ul>
              </div>
              <div class="footer-widget-wrapper">
                <h2 class="title">Useful Link</h2>
                <ul class="footer-nav-list">
                  <li><a href="privacy-policy.html#">Features</a></li>
                  <li><a href="privacy-policy.html#">Resources</a></li>
                  <li><a href="privacy-policy.html#">Service</a></li>
                  <li><a href="privacy-policy.html#">Team</a></li>
                  <li><a href="privacy-policy.html#">Collection</a></li>
                </ul>
              </div>
              <div class="footer-widget-wrapper">
                <h2 class="title">Product</h2>
                <ul class="footer-nav-list">
                  <li><a href="privacy-policy.html#">Live Chat</a></li>
                  <li><a href="privacy-policy.html#">Jirogram</a></li>
                  <li><a href="privacy-policy.html#">Datasetico</a></li>
                  <li><a href="privacy-policy.html#">Underline</a></li>
                  <li><a href="privacy-policy.html#">Keyword</a></li>
                </ul>
              </div>
            </div>
            <div class="copyright-area-inner">
              <ul class="social-links">
                <li><a href="privacy-policy.html#"><i class="fa-brands fa-facebook-f"></i></a></li>
                <li><a href="privacy-policy.html#"><i class="fa-brands fa-twitter"></i></a></li>
                <li><a href="privacy-policy.html#"><i class="fa-brands fa-instagram"></i></a></li>
                <li><a href="privacy-policy.html#"><i class="fa-brands fa-linkedin"></i></a></li>
              </ul>
              <div class="copyright-text">
                <p class="text">© 2022 <a href="privacy-policy.html#">Crowdyflow</a> Agency</p>
              </div>
            </div>
          </div>
        </footer>
        ...
        <div class="form-box-wrapper">
          <div class="login-form-box">
            ...
            <div class="form-wrapper">
              <form action="privacy-policy.html#" class="user-form">
                ...
                <div class="policy-field">
                  ...
                  <a href="privacy-policy.html#" class="forget-password">Forgot your password?</a>
                </div>
            ...
            <div class="form-wrapper">
              <form action="privacy-policy.html#" class="user-form">
                ...
                <div class="policy-field">
                  ...
                  <label for="d-policy">I agree to sassly <span><a href="privacy-policy.html#">Terms of Service.</a></span></label>
                </div>
                <button type="submit" class="subscribe-btn wc-btn-primary btn-text-flip"><span
