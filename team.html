    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-body">
          <form action="team.html#" class="form-search">
    ...
    <div id="smooth-content">
      <div class="body-wrapper body-booking">
        ...
        <main>
                ...
                <div class="section-header">
                  <div class="section-title-wrapper">
                    <div class="title-wrapper">
                      <h1 class="section-title large has_fade_anim">Meet our
                        experts</h1>
                    </div>
                  </div>
                  <div class="shape has_fade_anim" data-delay="0.30">
          ...
          <!-- team area start  -->
          <section class="team-area section-spacing pt-0">
            <div class="container">
              <div class="team-area-inner">
                <div class="team-wrapper-box">
                  <div class="team-wrapper">
                    ...
                    <div class="team-box has_fade_anim">
                      <div class="thumb">
                        <img src="assets/imgs/team/img-s-5.webp" alt="team image">
                      </div>
                      <div class="content">
                        <h3 class="name">Deland Stoy</h3>
                        <span class="designation">Quality Checker</span>
                      </div>
                    </div>
                    <div class="team-box has_fade_anim" data-delay="0.25">
                      <div class="thumb">
                        <img src="assets/imgs/team/img-s-6.webp" alt="team image">
                      </div>
                      <div class="content">
                        <h3 class="name">Kamer Ducal</h3>
                        <span class="designation">Junior developer</span>
                      </div>
                    </div>
                    <div class="team-box has_fade_anim" data-delay="0.35">
                      <div class="thumb">
                        <img src="assets/imgs/team/img-s-7.webp" alt="team image">
                      </div>
                      <div class="content">
                        <h3 class="name">Dimond Kiem</h3>
                        <span class="designation">Admin</span>
                      </div>
                    </div>
                    <div class="team-box has_fade_anim" data-delay="0.45">
                      <div class="thumb">
                        <img src="assets/imgs/team/img-s-8.webp" alt="team image">
                      </div>
                      <div class="content">
                        <h3 class="name">Kasia Ordo</h3>
                        <span class="designation">Assistant</span>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div class="container">
            <div class="footer-area-inner">
              ...
              <div class="footer-widget-wrapper">
                ...
                <ul class="footer-nav-list">
                  ...
                  <li><a href="team.html#">Press</a></li>
                  <li><a href="team.html#">Contact Us</a></li>
                  <li><a href="team.html#">System Status</a></li>
                </ul>
              </div>
              <div class="footer-widget-wrapper">
                ...
                <ul class="footer-nav-list">
                  ...
                  <li><a href="team.html#">Resources</a></li>
                  <li><a href="team.html#">Service</a></li>
                  <li><a href="team.html#">Team</a></li>
                  <li><a href="team.html#">Collection</a></li>
                </ul>
              </div>
              <div class="footer-widget-wrapper">
                <h2 class="title">Product</h2>
                <ul class="footer-nav-list">
                  <li><a href="team.html#">Live Chat</a></li>
                  <li><a href="team.html#">Jirogram</a></li>
                  <li><a href="team.html#">Datasetico</a></li>
                  <li><a href="team.html#">Underline</a></li>
                  <li><a href="team.html#">Keyword</a></li>
                </ul>
              </div>
            </div>
            <div class="copyright-area-inner">
              <ul class="social-links">
                ...
                <li><a href="team.html#"><i class="fa-brands fa-twitter"></i></a></li>
                <li><a href="team.html#"><i class="fa-brands fa-instagram"></i></a></li>
                <li><a href="team.html#"><i class="fa-brands fa-linkedin"></i></a></li>
              </ul>
        ...
        <div class="form-box-wrapper">
          <div class="login-form-box">
            ...
            <div class="form-wrapper">
              <form action="team.html#" class="user-form">
                ...
                <div class="policy-field">
                  ...
                  <a href="team.html#" class="forget-password">Forgot your password?</a>
                </div>
            ...
            <div class="form-wrapper">
              <form action="team.html#" class="user-form">
                ...
                <div class="policy-field">
                  ...
                  <label for="d-policy">I agree to sassly <span><a href="team.html#">Terms of Service.</a></span></label>
                </div>
                <button type="submit" class="subscribe-btn wc-btn-primary btn-text-flip"><span
