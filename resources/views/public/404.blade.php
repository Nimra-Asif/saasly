...
<head>
  ...
  <link rel="stylesheet" href="assets/css/master-error-404.css">
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-body">
          <form action="404.html#" class="form-search">
    ...
    <div id="smooth-content">
      <div class="body-wrapper body-booking">
        ...
        <main>
          ...
          <!-- error area start  -->
          <div class="error-area section-spacing">
            <div class="container">
              <div class="error-area-inner">
                <div class="shape-1">
                  <img src="assets/imgs/shape/shape-s-59.webp" alt="shape image">
                </div>
                <div class="shape-2">
                  <img src="assets/imgs/shape/shape-s-28.webp" alt="shape image">
                </div>
                <div class="error-thumb-wrapper">
                  <h1 class="thumb-title">Error page</h1>
                  <div class="error-thumb">
                    <img src="assets/imgs/shape/error-404.webp" alt="error image">
                  </div>
                </div>
                <div class="error-content">
                  <h2 class="title">We’ve lost this page</h2>
                  <p class="text">Sorry, the page you are looking for doesn’t exist or has been moved.
                  </p>
                  <a href="contact.html" class="wc-btn wc-btn-primary btn-text-flip"> <span
                      data-text="Back to home">Back to home</span></a>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="footer-area-inner">
              ...
              <div class="footer-widget-wrapper">
                ...
                <ul class="footer-nav-list">
                  ...
                  <li><a href="404.html#">Resources</a></li>
              ...
              <div class="footer-widget-wrapper">
                ...
                <ul class="footer-nav-list">
                  <li><a href="404.html#">Live Chat</a></li>
                  <li><a href="404.html#">Jirogram</a></li>
                  <li><a href="404.html#">Datasetico</a></li>
                  <li><a href="404.html#">Underline</a></li>
                  <li><a href="404.html#">Keyword</a></li>
                </ul>
              </div>
            </div>
            <div class="copyright-area-inner">
              <ul class="social-links">
                <li><a href="404.html#"><i class="fa-brands fa-facebook-f"></i></a></li>
                <li><a href="404.html#"><i class="fa-brands fa-twitter"></i></a></li>
                <li><a href="404.html#"><i class="fa-brands fa-instagram"></i></a></li>
                <li><a href="404.html#"><i class="fa-brands fa-linkedin"></i></a></li>
              </ul>
        ...
        <div class="form-box-wrapper">
          <div class="login-form-box">
            ...
            <div class="form-wrapper">
              <form action="404.html#" class="user-form">
                ...
                <div class="policy-field">
                  ...
                  <a href="404.html#" class="forget-password">Forgot your password?</a>
                </div>
            ...
            <div class="form-wrapper">
              <form action="404.html#" class="user-form">
                ...
                <div class="policy-field">
                  ...
                  <label for="d-policy">I agree to sassly <span><a href="404.html#">Terms of Service.</a></span></label>
                </div>
                <button type="submit" class="subscribe-btn wc-btn-primary btn-text-flip"><span
