...
<head>
  ...
  <title>Sassly All Template</title>
  ...
  <link rel="stylesheet" href="assets/css/master-all-template.css">
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-body">
          <form action="all-template.html#" class="form-search">
          ...
          <nav class="main-menu">
            <ul>
              ...
              <li class="menu-item-has-children">
                <a href="all-template.html#">Pages</a>
                <ul class="dp-menu">
                  <li><a href="integration.html">integration</a></li>
                  <li><a href="integration-single.html">integration single</a></li>
                  <li><a href="about.html">about</a></li>
              ...
              <li class="menu-item-has-children">
                <a href="all-template.html#">blog</a>
                <ul class="dp-menu">
    ...
    <div id="smooth-content">
      <div class="body-wrapper body-booking">
        ...
        <main>
                ...
                <div class="section-header">
                  <div class="section-title-wrapper">
                    <div class="title-wrapper">
                      <h1 class="section-title large has_fade_anim">Our ready
                        templates</h1>
                    </div>
                  </div>
          ...
          <div class="templates-area section-spacing pt-0">
            <div class="container">
              ...
              <div class="btn-wrap">
                <a href="contact.html" class="wc-btn-primary bordered">Load More</a>
              </div>
            </div>
          </div>
          <!-- templates area end  -->
            ...
            <div class="footer-area-inner">
              ...
              <div class="footer-widget-wrapper">
                ...
                <ul class="footer-nav-list">
                  <li><a href="all-template.html#">about</a></li>
                  <li><a href="all-template.html#">Careers</a></li>
                  <li><a href="all-template.html#">Press</a></li>
                  <li><a href="all-template.html#">Contact Us</a></li>
                  <li><a href="all-template.html#">System Status</a></li>
                </ul>
              </div>
              <div class="footer-widget-wrapper">
                <h2 class="title">Useful Link</h2>
                <ul class="footer-nav-list">
                  <li><a href="all-template.html#">Features</a></li>
                  <li><a href="all-template.html#">Resources</a></li>
                  <li><a href="all-template.html#">Service</a></li>
                  <li><a href="all-template.html#">Team</a></li>
                  <li><a href="all-template.html#">Collection</a></li>
                </ul>
              </div>
              <div class="footer-widget-wrapper">
                <h2 class="title">Product</h2>
                <ul class="footer-nav-list">
                  <li><a href="all-template.html#">Live Chat</a></li>
                  <li><a href="all-template.html#">Jirogram</a></li>
                  <li><a href="all-template.html#">Datasetico</a></li>
                  <li><a href="all-template.html#">Underline</a></li>
                  <li><a href="all-template.html#">Keyword</a></li>
                </ul>
              </div>
            </div>
            <div class="copyright-area-inner">
              <ul class="social-links">
                <li><a href="all-template.html#"><i class="fa-brands fa-facebook-f"></i></a></li>
                <li><a href="all-template.html#"><i class="fa-brands fa-twitter"></i></a></li>
                <li><a href="all-template.html#"><i class="fa-brands fa-instagram"></i></a></li>
                <li><a href="all-template.html#"><i class="fa-brands fa-linkedin"></i></a></li>
              </ul>
        ...
        <div class="form-box-wrapper">
          <div class="login-form-box">
            ...
            <div class="form-wrapper">
              <form action="all-template.html#" class="user-form">
                ...
                <div class="policy-field">
                  ...
                  <a href="all-template.html#" class="forget-password">Forgot your password?</a>
                </div>
            ...
            <div class="form-wrapper">
              <form action="all-template.html#" class="user-form">
                ...
                <div class="policy-field">
                  ...
                  <label for="d-policy">I agree to sassly <span><a href="all-template.html#">Terms of Service.</a></span></label>
                </div>
                <button type="submit" class="subscribe-btn wc-btn-primary btn-text-flip"><span
