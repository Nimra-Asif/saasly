...
<head>
  ...
  <title>Sassly Integration Single</title>
  ...
  <link rel="stylesheet" href="assets/css/master-integration-single.css">
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-body">
          <form action="integration-single.html#" class="form-search">
          ...
          <nav class="main-menu">
            <ul>
              ...
              <li class="menu-item-has-children">
                <a href="integration-single.html#">Pages</a>
                <ul class="dp-menu">
                  <li><a href="integration.html">integration</a></li>
                  <li><a href="integration-single.html">integration single</a></li>
                  <li><a href="about.html">about</a></li>
              ...
              <li>
                <a href="integration-single.html#">blog</a>
                <ul class="dp-menu">
    ...
    <div id="smooth-content">
      <div class="body-wrapper body-booking">
        ...
        <main>
          ...
          <!-- hero area start  -->
          <div class="hero-area section-spacing pb-0">
            <div class="container">
              <div class="hero-area-inner">
                <div class="section-header">
                  <div class="section-title-wrapper">
                    <div class="title-wrapper">
                      <h1 class="section-title large has_fade_anim">Sassly + Zapier</h1>
                    </div>
                  </div>
                  <div class="text-wrapper">
                    <p class="text has_fade_anim" data-delay="0.30">Everything you need to dominate app service-fortified with the
                      industry’s #1 rated our customer support.</p>
                  </div>
                  <div class="btn-wrapper has_fade_anim" data-delay="0.45">
                    <a href="integration-single.html#" class="wc-btn wc-btn-normal btn-text-flip"> <span
                        data-text="Connect Zapier">Connect Zapier</span><img src="assets/imgs/icon/angle-right.webp"
                        alt="icon image"></a>
                  </div>
                </div>
                <div class="section-thumb has_fade_anim" data-delay="0.60">
                  <img src="assets/imgs/gallery/img-s-56.webp" alt="gallery image">
                </div>
                <div class="app-info-wrapper">
                  <div class="app-info has_fade_anim">
                    <div class="title-wrapper">
                      <h3 class="title">Overview</h3>
                    </div>
                    <div class="text-wrapper">
                      <p class="text">Below is a suggested outlines for a privacy policy for a Software as a Service
                        (SaaS) company. keep in mind that privacy policies should be customized to reflect the specific
                        practices and policies of your company, as well as any applicable laws and regulations. It's
                        also
                        recommended to have legal counsel review your privacy policy to ensure compliance.</p>
                    </div>
                  </div>
                  <div class="app-info has_fade_anim">
                    <div class="title-wrapper">
                      <h3 class="title">You can also create integrations actions using the following triggers:</h3>
                    </div>
                    <div class="text-wrapper">
                      <p class="text">Below is a suggested outlines for a privacy policy for a Software as a Service
                        (SaaS) company. keep in mind that privacy policies should be customized to reflect the specific
          ...
          <div class="integration-area section-spacing">
            <div class="container">
              <div class="integration-area-inner">
                <div class="shape-1">
                  <img src="assets/imgs/shape/shape-s-54.webp" data-speed="0.8" alt="shape image">
                </div>
                <div class="shape-2">
                  <img src="assets/imgs/shape/shape-s-28.webp" data-speed="0.8" alt="shape image">
                </div>
                <div class="section-header">
                  <div class="section-title-wrapper">
                    <div class="title-wrapper">
                      <h2 class="section-title has_fade_anim">See Sassly more <br>
                        integrations</h2>
                    </div>
                  </div>
                  <div class="text-wrapper">
                    <p class="text has_fade_anim">Winners never quit and quitters never win. Take all negative words out of your
                      mental dictionary</p>
                  </div>
                </div>
                <div class="integration-cards-wrapper">

                  <ul class="nav nav-pills has_fade_anim" id="pills-tab" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button class="nav-link" id="pills-third-tab" data-bs-toggle="pill" data-bs-target="#pills-third"
                        type="button" role="tab" aria-controls="pills-third" aria-selected="false">CRM</button>
                    </li>
                    <li class="nav-item" role="presentation">
                    ...
                    <li class="nav-item" role="presentation">
                      <button class="nav-link" id="pills-fifth-tab" data-bs-toggle="pill" data-bs-target="#pills-fifth"
                        type="button" role="tab" aria-controls="pills-fifth" aria-selected="false">Streaming</button>
                    </li>
                  </ul>
                      ...
                      <div class="integration-cards">
                        <div class="has_fade_anim">
                          <div class="integration-card">
                            <div class="thumb">
                              <img src="assets/imgs/icon/icon-int-1.webp" alt="icon image">
                            </div>
                            <div class="content">
                              <h3 class="title">Google
                                <span>CRM</span>
                              </h3>
                              <p class="text">Build online communities with effective audience communication with
                                various
                                track
                              </p>
                              <a href="integration-single.html#" class="wc-btn wc-btn-normal">Explore Integration<i
                        ...
                        <div class="has_fade_anim" data-delay="0.25">
                          <div class="integration-card">
                            <div class="thumb">
                              <img src="assets/imgs/icon/icon-int-2.webp" alt="icon image">
                            </div>
                            <div class="content">
                              <h3 class="title">Spotify
                        ...
                        <div class="has_fade_anim" data-delay="0.35">
                          <div class="integration-card">
                            <div class="thumb">
                              <img src="assets/imgs/icon/icon-int-3.webp" alt="icon image">
                            </div>
                            <div class="content">
                              <h3 class="title">Dropbox
                                <span>Streaming</span>
                              </h3>
                              <p class="text">Build online communities with effective audience communication with
                                various
                        ...
                        <div class="has_fade_anim">
                          <div class="integration-card">
                            <div class="thumb">
                              <img src="assets/imgs/icon/icon-int-4.webp" alt="icon image">
                            </div>
                            <div class="content">
                              <h3 class="title">Zapier
                        ...
                        <div class="has_fade_anim" data-delay="0.25">
                          ...
                          <div class="integration-card">
                            <div class="thumb">
                              <img src="assets/imgs/icon/icon-int-5.webp" alt="icon image">
                            </div>
                            <div class="content">
                              <h3 class="title">MODX GPT
                                <span>Streaming</span>
                              </h3>
                              <p class="text">Build online communities with effective audience communication with
                                various
                        ...
                        <div class="has_fade_anim" data-delay="0.35">
                          <div class="integration-card">
                            <div class="thumb">
                              <img src="assets/imgs/icon/icon-int-6.webp" alt="icon image">
                            </div>
                            <div class="content">
                              <h3 class="title">Google Photos
                                <span>Social Media</span>
                              </h3>
                              <p class="text">Build online communities with effective audience communication with
                                various
          ...
          <section class="faq-area section-spacing">
            <div class="container">
              <div class="faq-area-inner">
                <div class="shape-1">
                  <img src="assets/imgs/shape/shape-s-53.webp" alt="shape image">
                </div>
                      ...
                      <div class="accordion-item">
                        <h2 class="accordion-header" id="flush-headingOne">
                          <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                            ...
                            aria-controls="flush-collapseOne">What
                            is Sassly?</button>
                        </h2>
                      ...
                      <div class="accordion-item">
                        <h2 class="accordion-header" id="flush-headingTwo">
                          <button class="accordion-button" type="button" data-bs-toggle="collapse"
                            ...
                            aria-controls="flush-collapseTwo">Why
                            should I choose Sassly?</button>
                        </h2>
          ...
          <section class="newsletter-area section-spacing">
            <div class="container">
              <div class="newsletter-area-inner">
                <div class="section-header">
                  <div class="section-title-wrapper">
                    <div class="title-wrapper">
                      <h2 class="section-title has_fade_anim">Join our 120k+ big community <br>
                        connect our newsletter</h2>
                    </div>
                  </div>
                  <div class="form-wrapper has_fade_anim">
                    <form action="integration-single.html#" class="subscribe-form">
                      <div class="input-field">
                        <input type="email" placeholder="Enter your email" value="charry.maron@sassly.net">
                        <button type="submit" class="subscribe-btn wc-btn-primary btn-text-flip"><span
                            data-text="Subscribe">Subscribe</span></button>
                      </div>
                    </form>
                  </div>
                  <div class="feature-list-wrapper has_fade_anim">
                    <div class="feature-list">
                      <div class="feature-list-item">
                        <span class="icon">
                          <img src="assets/imgs/icon/check-8.webp" alt="icon image">
                        </span>
                        <p class="text">Update offer</p>
                      </div>
                      <div class="feature-list-item">
                        <span class="icon">
                          <img src="assets/imgs/icon/check-8.webp" alt="icon image">
                        </span>
                        <p class="text">No spam</p>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div class="footer-area-inner">
              ...
              <div class="footer-widget-wrapper">
                ...
                <ul class="footer-nav-list">
                  <li><a href="integration-single.html#">about</a></li>
                  <li><a href="integration-single.html#">Careers</a></li>
                  <li><a href="integration-single.html#">Press</a></li>
                  <li><a href="integration-single.html#">Contact Us</a></li>
                  <li><a href="integration-single.html#">System Status</a></li>
                </ul>
              </div>
              <div class="footer-widget-wrapper">
                <h2 class="title">Useful Link</h2>
                <ul class="footer-nav-list">
                  <li><a href="integration-single.html#">Features</a></li>
                  <li><a href="integration-single.html#">Resources</a></li>
                  <li><a href="integration-single.html#">Service</a></li>
                  <li><a href="integration-single.html#">Team</a></li>
                  <li><a href="integration-single.html#">Collection</a></li>
                </ul>
              </div>
              <div class="footer-widget-wrapper">
                <h2 class="title">Product</h2>
                <ul class="footer-nav-list">
                  <li><a href="integration-single.html#">Live Chat</a></li>
                  <li><a href="integration-single.html#">Jirogram</a></li>
                  <li><a href="integration-single.html#">Datasetico</a></li>
                  <li><a href="integration-single.html#">Underline</a></li>
                  <li><a href="integration-single.html#">Keyword</a></li>
                </ul>
              </div>
            </div>
            <div class="copyright-area-inner">
              <ul class="social-links">
                <li><a href="integration-single.html#"><i class="fa-brands fa-facebook-f"></i></a></li>
                <li><a href="integration-single.html#"><i class="fa-brands fa-twitter"></i></a></li>
                <li><a href="integration-single.html#"><i class="fa-brands fa-instagram"></i></a></li>
                <li><a href="integration-single.html#"><i class="fa-brands fa-linkedin"></i></a></li>
              </ul>
        ...
        <div class="form-box-wrapper">
          <div class="login-form-box">
            ...
            <div class="form-wrapper">
              <form action="integration-single.html#" class="user-form">
                <div class="input-field">
                ...
                <div class="policy-field">
                  ...
                  <label for="p-policy">Remember me</label>
                  <a href="integration-single.html#" class="forget-password">Forgot your password?</a>
                </div>
                <button type="submit" class="subscribe-btn wc-btn-primary btn-text-flip"><span
            ...
            <div class="form-wrapper">
              <form action="integration-single.html#" class="user-form">
                ...
                <div class="policy-field">
                  ...
                  <label for="d-policy">I agree to sassly <span><a href="integration-single.html#">Terms of Service.</a></span></label>
                </div>
                <button type="submit" class="subscribe-btn wc-btn-primary btn-text-flip"><span
