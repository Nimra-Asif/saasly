...
<head>
  ...
  <title>Sassly Integration</title>
  ...
  <link rel="stylesheet" href="assets/css/master-integration.css">
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-body">
          <form action="integration.html#" class="form-search">
          ...
          <nav class="main-menu">
            <ul>
              ...
              <li class="menu-item-has-children">
                <a href="integration.html#">Pages</a>
                <ul class="dp-menu">
                  <li><a href="integration.html">integration</a></li>
                  <li><a href="integration-single.html">integration single</a></li>
                  <li><a href="about.html">about</a></li>
              ...
              <li>
                <a href="integration.html#">blog</a>
                <ul class="dp-menu">
      ...
      <div class="body-wrapper body-booking">
        ...
        <main>
          ...
          <div class="hero-area section-spacing pb-0">
            <div class="shape-1">
              <img src="assets/imgs/shape/shape-s-52.webp" alt="shape image">
            </div>
            <div class="container">
                ...
                <div class="section-header">
                  <div class="section-title-wrapper">
                    <div class="title-wrapper">
                      <h1 class="section-title large has_fade_anim">App Integration</h1>
                    </div>
                  </div>
                  ...
                  <div class="btn-wrapper has_fade_anim" data-delay="0.45">
                    <a href="integration.html#" class="wc-btn wc-btn-normal btn-text-flip"> <span
                        data-text="All Integration">All
                        Integration</span><img src="assets/imgs/icon/angle-right.webp" alt="icon image"></a>
                  </div>
                </div>
                <div class="section-thumb has_fade_anim" data-delay="0.60">
                  <img src="assets/imgs/gallery/img-s-55.webp" alt="gallery image">
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="container">
              <div class="integration-area-inner">
                ...
                <div class="section-header">
                  <div class="section-title-wrapper">
                    <div class="title-wrapper">
                      <h2 class="section-title has_fade_anim">Seamless Integration <br>
                        enhancing experience with <br>
                        Sassly solution</h2>
                    </div>
                  </div>
                  <div class="text-wrapper">
                          ...
                          <a href="integration-single.html">
                            <div class="integration-card">
                              ...
                              <div class="content">
                                ...
                                <span class="wc-btn wc-btn-normal">Explore Integration<i
                          ...
                          <a href="integration-single.html">
                            <div class="integration-card">
                              ...
                              <div class="content">
                                ...
                                <a href="integration.html#" class="wc-btn wc-btn-normal">Explore Integration<i
          ...
          <section class="faq-area section-spacing">
            <div class="container">
              <div class="faq-area-inner">
                <div class="shape-1">
                  <img src="assets/imgs/shape/shape-s-53.webp" data-speed="0.8" alt="shape image">
                </div>
            ...
            <div class="container">
              <div class="cta-area-inner">
                <div class="section-header">
                  <div class="section-title-wrapper">
                    <div class="title-wrapper">
                      <h2 class="section-title has_fade_anim">Don’t miss, grab the <br>
                        opportunity now! </h2>
                    </div>
                  </div>
                  <div class="text-wrapper">
            ...
            <div class="footer-area-inner">
              ...
              <div class="footer-widget-wrapper">
                ...
                <ul class="footer-nav-list">
                  <li><a href="integration.html#">about</a></li>
                  <li><a href="integration.html#">Careers</a></li>
                  <li><a href="integration.html#">Press</a></li>
                  <li><a href="integration.html#">Contact Us</a></li>
                  <li><a href="integration.html#">System Status</a></li>
                </ul>
              </div>
              <div class="footer-widget-wrapper">
                <h2 class="title">Useful Link</h2>
                <ul class="footer-nav-list">
                  <li><a href="integration.html#">Features</a></li>
                  <li><a href="integration.html#">Resources</a></li>
                  <li><a href="integration.html#">Service</a></li>
                  <li><a href="integration.html#">Team</a></li>
                  <li><a href="integration.html#">Collection</a></li>
                </ul>
              </div>
              <div class="footer-widget-wrapper">
                <h2 class="title">Product</h2>
                <ul class="footer-nav-list">
                  <li><a href="integration.html#">Live Chat</a></li>
                  <li><a href="integration.html#">Jirogram</a></li>
                  <li><a href="integration.html#">Datasetico</a></li>
                  <li><a href="integration.html#">Underline</a></li>
                  <li><a href="integration.html#">Keyword</a></li>
                </ul>
              </div>
            </div>
            <div class="copyright-area-inner">
              <ul class="social-links">
                <li><a href="integration.html#"><i class="fa-brands fa-facebook-f"></i></a></li>
                <li><a href="integration.html#"><i class="fa-brands fa-twitter"></i></a></li>
                <li><a href="integration.html#"><i class="fa-brands fa-instagram"></i></a></li>
                <li><a href="integration.html#"><i class="fa-brands fa-linkedin"></i></a></li>
              </ul>
        ...
        <div class="form-box-wrapper">
          <div class="login-form-box">
            ...
            <div class="form-wrapper">
              <form action="integration.html#" class="user-form">
                ...
                <div class="policy-field">
                  ...
                  <a href="integration.html#" class="forget-password">Forgot your password?</a>
                </div>
            ...
            <div class="form-wrapper">
              <form action="integration.html#" class="user-form">
                ...
                <div class="policy-field">
                  ...
                  <label for="d-policy">I agree to sassly <span><a href="integration.html#">Terms of Service.</a></span></label>
                </div>
                <button type="submit" class="subscribe-btn wc-btn-primary btn-text-flip"><span
