    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-body">
          <form action="faq.html#" class="form-search">
                ...
                <div class="section-header">
                  <div class="section-title-wrapper">
                    <div class="title-wrapper">
                      <h2 class="section-title large has_fade_anim">Frequently
                        Asked
                        Questions
                      </h2>
                    </div>
                  ...
                  <div class="text-wrapper">
                    <p class="text has_fade_anim" data-delay="0.30">Ability to understand and generate content in different to expand their reach and
            ...
            <div class="footer-area-inner">
              ...
              <div class="footer-widget-wrapper">
                ...
                <ul class="footer-nav-list">
                  ...
                  <li><a href="faq.html#">Jirogram</a></li>
                  <li><a href="faq.html#">Datasetico</a></li>
                  <li><a href="faq.html#">Underline</a></li>
                  <li><a href="faq.html#">Keyword</a></li>
                </ul>
              </div>
            </div>
            <div class="copyright-area-inner">
              <ul class="social-links">
                <li><a href="faq.html#"><i class="fa-brands fa-facebook-f"></i></a></li>
                <li><a href="faq.html#"><i class="fa-brands fa-twitter"></i></a></li>
                <li><a href="faq.html#"><i class="fa-brands fa-instagram"></i></a></li>
                <li><a href="faq.html#"><i class="fa-brands fa-linkedin"></i></a></li>
              </ul>
        ...
        <div class="form-box-wrapper">
          <div class="login-form-box">
            ...
            <div class="form-wrapper">
              <form action="faq.html#" class="user-form">
                ...
                <div class="policy-field">
                  ...
                  <a href="faq.html#" class="forget-password">Forgot your password?</a>
                </div>
            ...
            <div class="form-wrapper">
              <form action="faq.html#" class="user-form">
                ...
                <div class="policy-field">
                  ...
                  <label for="d-policy">I agree to sassly <span><a href="faq.html#">Terms of Service.</a></span></label>
                </div>
                <button type="submit" class="subscribe-btn wc-btn-primary btn-text-flip"><span
