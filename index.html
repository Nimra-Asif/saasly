              ...
              <div class="hero-area-inner">
                ...
                <div class="section-content">
                  ...
                  <div class="btn-wrapper has_fade_anim" data-delay="0.45">
                    <a href="index.html#" class="wc-btn wc-btn-primary btn-text-flip primary-bg"> <span
                        data-text="Desktop version">Desktop
                        version</span></a>
                    <a href="index.html#" class="wc-btn wc-btn-primary btn-text-flip"> <span data-text="Mobile version">Mobile
                        version</span></a>
                  </div>
            ...
            <div class="footer-area-inner">
              ...
              <div class="footer-widget-wrapper">
                ...
                <ul class="footer-nav-list">
                  ...
                  <li><a href="index.html#">System Status</a></li>
                </ul>
              </div>
              ...
              <div class="footer-widget-wrapper">
                ...
                <ul class="footer-nav-list">
                  ...
                  <li><a href="index.html#">Jirogram</a></li>
                  <li><a href="index.html#">Datasetico</a></li>
                  <li><a href="index.html#">Underline</a></li>
                  <li><a href="index.html#">Keyword</a></li>
                </ul>
              </div>
              <div class="footer-widget-wrapper">
            ...
            <div class="form-wrapper">
              <form action="index.html#" class="user-form">
                ...
                <div class="policy-field">
                  ...
                  <a href="index.html#" class="forget-password">Forgot your password?</a>
                </div>
            ...
            <div class="form-wrapper">
              <form action="index.html#" class="user-form">
                ...
                <div class="policy-field">
                  ...
                  <label for="d-policy">I agree to sassly <span><a href="index.html#">Terms of Service.</a></span></label>
                </div>
                <button type="submit" class="subscribe-btn wc-btn-primary btn-text-flip"><span
