...
<head>
  ...
  <title>Sassly Blog Details</title>
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-body">
          <form action="blog-details.html#" class="form-search">
            ...
            <div class="container">
              <div class="blog-details-area-inner">
                <div class="blog-details-main-wrapper">
                  <div class="section-heading">
                    <div class="section-title-wrapper">
                      <div class="title-wrapper">
                        <h1 class="section-title large has_fade_anim">Crafting a brand identity for
                          a digital product</h1>
                      </div>
                    </div>
                  </div>
                  <div class="meta has_fade_anim" data-delay="0.30">
                    <div class="meta-box">
                      <div class="icon">
                        <img src="assets/imgs/icon/user-orange.webp" alt="">
                      </div>
                      <div class="content">
                        <p class="title">Written by</p>
                        <p class="text">Steven Dirk</p>
                      </div>
                    </div>
                    <div class="meta-box">
                      <div class="icon">
                        <img src="assets/imgs/icon/date-orange.webp" alt="">
                      </div>
                      <div class="content">
                    ...
                    <div class="meta-box">
                      <div class="icon">
                        <img src="assets/imgs/icon/comment-orange.webp" alt="">
                      </div>
                      <div class="content">
                  ...
                  <div class="thumb-main has_fade_anim" data-delay="0.45">
                    <img src="assets/imgs/blog/img-s-7.webp" alt="blog image">
                  </div>
                  <div class="section-main-content">
                    <div class="social-meta-box">
                      ...
                      <ul class="social-icons">
                        <li><a href="blog-details.html#"><i class="fa-brands fa-twitter"></i></a></li>
                        <li><a href="blog-details.html#"><i class="fa-brands fa-dribbble"></i></a></li>
                        <li><a href="blog-details.html#"><i class="fa-brands fa-instagram"></i></a></li>
                      </ul>
                    </div>
                      ...
                      <div class="content-box">
                        ...
                        <div class="quote-box">
                          ...
                          <div class="quote-text">
                            <p class="text">Effortless comfortable full leather lining catching unique detail to the toe
                              low cut-away side clean and sleek harmony.</p>
                            <span class="author has-left-line">Stav drive</span>
                          </div>
                        </div>
                        <div class="text-wrapper">
                        ...
                        <div class="tags-wrapper">
                          <div class="tags">
                            <a href="blog-details.html#" class="tag">Saas</a>
                            <a href="blog-details.html#" class="tag">Software</a>
                            <a href="blog-details.html#" class="tag">Business</a>
                            <a href="blog-details.html#" class="tag">Agency</a>
                            <a href="blog-details.html#" class="tag">Computer</a>
                          </div>
                        </div>
                      </div>
            ...
            <div class="footer-area-inner">
              ...
              <div class="footer-widget-wrapper">
                ...
                <ul class="footer-nav-list">
                  ...
                  <li><a href="blog-details.html#">Press</a></li>
                  <li><a href="blog-details.html#">Contact Us</a></li>
                  <li><a href="blog-details.html#">System Status</a></li>
                </ul>
              </div>
              <div class="footer-widget-wrapper">
                <h2 class="title">Useful Link</h2>
                <ul class="footer-nav-list">
                  <li><a href="blog-details.html#">Features</a></li>
                  <li><a href="blog-details.html#">Resources</a></li>
                  <li><a href="blog-details.html#">Service</a></li>
                  <li><a href="blog-details.html#">Team</a></li>
                  <li><a href="blog-details.html#">Collection</a></li>
                </ul>
              </div>
              <div class="footer-widget-wrapper">
                <h2 class="title">Product</h2>
                <ul class="footer-nav-list">
                  <li><a href="blog-details.html#">Live Chat</a></li>
                  <li><a href="blog-details.html#">Jirogram</a></li>
                  <li><a href="blog-details.html#">Datasetico</a></li>
                  <li><a href="blog-details.html#">Underline</a></li>
                  <li><a href="blog-details.html#">Keyword</a></li>
                </ul>
              </div>
            </div>
            <div class="copyright-area-inner">
              <ul class="social-links">
                <li><a href="blog-details.html#"><i class="fa-brands fa-facebook-f"></i></a></li>
                <li><a href="blog-details.html#"><i class="fa-brands fa-twitter"></i></a></li>
                <li><a href="blog-details.html#"><i class="fa-brands fa-instagram"></i></a></li>
                <li><a href="blog-details.html#"><i class="fa-brands fa-linkedin"></i></a></li>
              </ul>
        ...
        <div class="form-box-wrapper">
          <div class="login-form-box">
            ...
            <div class="form-wrapper">
              <form action="blog-details.html#" class="user-form">
                <div class="input-field">
                ...
                <div class="policy-field">
                  ...
                  <a href="blog-details.html#" class="forget-password">Forgot your password?</a>
                </div>
                <button type="submit" class="subscribe-btn wc-btn-primary btn-text-flip"><span
            ...
            <div class="form-wrapper">
              <form action="blog-details.html#" class="user-form">
                ...
                <div class="policy-field">
                  ...
                  <label for="d-policy">I agree to sassly <span><a href="blog-details.html#">Terms of Service.</a></span></label>
                </div>
                <button type="submit" class="subscribe-btn wc-btn-primary btn-text-flip"><span
