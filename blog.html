    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-body">
          <form action="blog.html#" class="form-search">
              ...
              <div class="blog-area-inner">
                <div class="blog-wrapper-box">
                  ...
                  <div class="more-btn-wrapper">
                    <a href="blog.html#" class="wc-btn wc-btn-primary bordered btn-text-flip"> <span data-text="Load More">Load
                        More</span></a>
                  </div>
                </div>
              </div>
            ...
            <div class="footer-area-inner">
              ...
              <div class="footer-widget-wrapper">
                ...
                <ul class="footer-nav-list">
                  ...
                  <li><a href="blog.html#">System Status</a></li>
                </ul>
              </div>
              <div class="footer-widget-wrapper">
                ...
                <ul class="footer-nav-list">
                  ...
                  <li><a href="blog.html#">Collection</a></li>
                </ul>
              </div>
              <div class="footer-widget-wrapper">
                <h2 class="title">Product</h2>
                <ul class="footer-nav-list">
                  <li><a href="blog.html#">Live Chat</a></li>
                  <li><a href="blog.html#">Jirogram</a></li>
                  <li><a href="blog.html#">Datasetico</a></li>
                  <li><a href="blog.html#">Underline</a></li>
                  <li><a href="blog.html#">Keyword</a></li>
                </ul>
              </div>
            </div>
            <div class="copyright-area-inner">
              <ul class="social-links">
                <li><a href="blog.html#"><i class="fa-brands fa-facebook-f"></i></a></li>
                <li><a href="blog.html#"><i class="fa-brands fa-twitter"></i></a></li>
                <li><a href="blog.html#"><i class="fa-brands fa-instagram"></i></a></li>
                <li><a href="blog.html#"><i class="fa-brands fa-linkedin"></i></a></li>
              </ul>
        ...
        <div class="form-box-wrapper">
          <div class="login-form-box">
            ...
            <div class="form-wrapper">
              <form action="blog.html#" class="user-form">
                ...
                <div class="policy-field">
                  ...
                  <a href="blog.html#" class="forget-password">Forgot your password?</a>
                </div>
            ...
            <div class="form-wrapper">
              <form action="blog.html#" class="user-form">
                ...
                <div class="policy-field">
                  ...
                  <label for="d-policy">I agree to sassly <span><a href="blog.html#">Terms of Service.</a></span></label>
                </div>
                <button type="submit" class="subscribe-btn wc-btn-primary btn-text-flip"><span
