    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-body">
          <form action="contact.html#" class="form-search">
                ...
                <div class="section-header">
                  <div class="section-title-wrapper">
                    <div class="title-wrapper">
                      <h1 class="section-title large has_fade_anim">Let’s get
                        in touch</h1>
                    </div>
                  </div>
                  <div class="shape has_fade_anim" data-fade-from="left" data-delay="0.30">
                    <img src="assets/imgs/shape/shape-s-56.webp" alt="shape image">
                  </div>
                  <div class="text-wrapper">
                    <p class="text has_fade_anim" data-delay="0.45">Everything you need to dominate app service fortified the industry’s
                      #1 rated our
                      customer support.</p>
                  </div>
                </div>
            ...
            <div class="container">
              <div class="map-area-inner">
                <div class="map-wrapper has_fade_anim" data-delay="0.60">
                  <img src="assets/imgs/gallery/img-s-57.webp" alt="map image">
                </div>
              </div>
            </div>
          </div>
          ...
          <section class="contact-area section-spacing">
            <div class="container">
              <div class="contact-area-inner">
                <div class="shape-1">
                  <img src="assets/imgs/shape/shape-s-57.webp" data-speed="0.8" alt="shape image">
                </div>
                <div class="shape-2">
                  <img src="assets/imgs/shape/shape-s-58.webp" data-speed="0.8" alt="shape image">
                </div>
                <div class="section-heading has_fade_anim">
                  <div class="section-title-wrapper">
                    <div class="title-wrapper">
                      <h2 class="section-title">Let’s
                        <span>contact</span>
                        for
                        better
                        result
                  ...
                  <div class="meta-list">
                    <ul>
                      <li><a href="mailto:inquiry@binox.com">inquiry@sassly.com</a></li>
                      <li>1712 Down Street <br>
                        Monmouth Alex Junction,
                        Florida 08852</li>
                    </ul>
                  </div>
                </div>
                <div class="contact-wrapper has_fade_anim" data-delay="0.30">
                  ...
                  <form>
                    ...
                    <button type="submit" class="subscribe-btn wc-btn-primary btn-text-flip"><span
                        data-text="Send now">Send now</span></button>
                  </form>
                </div>
              </div>
            </div>
          ...
          <div class="container">
            <div class="footer-area-inner">
              ...
              <div class="footer-widget-wrapper">
                ...
                <ul class="footer-nav-list">
                  ...
                  <li><a href="contact.html#">System Status</a></li>
                </ul>
              </div>
              <div class="footer-widget-wrapper">
              ...
              <div class="footer-widget-wrapper">
                ...
                <ul class="footer-nav-list">
                  ...
                  <li><a href="contact.html#">Jirogram</a></li>
                  <li><a href="contact.html#">Datasetico</a></li>
                  <li><a href="contact.html#">Underline</a></li>
                  <li><a href="contact.html#">Keyword</a></li>
                </ul>
              </div>
            </div>
            <div class="copyright-area-inner">
              <ul class="social-links">
                ...
                <li><a href="contact.html#"><i class="fa-brands fa-linkedin"></i></a></li>
              </ul>
        ...
        <div class="form-box-wrapper">
          <div class="login-form-box">
            ...
            <div class="form-wrapper">
              <form action="contact.html#" class="user-form">
                <div class="input-field">
                ...
                <div class="policy-field">
                  ...
                  <a href="contact.html#" class="forget-password">Forgot your password?</a>
                </div>
                <button type="submit" class="subscribe-btn wc-btn-primary btn-text-flip"><span
            ...
            <div class="form-wrapper">
              <form action="contact.html#" class="user-form">
                ...
                <div class="policy-field">
                  ...
                  <label for="d-policy">I agree to sassly <span><a href="contact.html#">Terms of Service.</a></span></label>
                </div>
                <button type="submit" class="subscribe-btn wc-btn-primary btn-text-flip"><span
