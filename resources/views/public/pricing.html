...
<head>
  ...
  <link rel="stylesheet" href="assets/css/master-pricing.css">
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-body">
          <form action="pricing.html#" class="form-search">
    ...
    <div class="container">
      <div class="header-area__inner">
        ...
        <div class="header__button">
          <a href="contact.html" class="wc-btn wc-btn-primary btn-text-flip"> <span data-text="Sign up">Sign
              up</span></a>
        </div>
                ...
                <div class="section-header">
                  <div class="section-title-wrapper">
                    <div class="title-wrapper">
                      <h1 class="section-title large has_fade_anim">Fair pricing for any
                        business</h1>
                    </div>
                  </div>
                  <div class="text-wrapper">
                    <p class="text has_fade_anim" data-delay="0.30">Ability to understand and generate content in
                      different to expand their reach and
                      appeal to a wider audience.</p>
                  </div>
                </div>
                <div class="wcf__toggle_switcher style-2">
                  <div class="slide-toggle-wrapper has_fade_anim" data-delay="0.45">
                    ...
                    <div class="toggle-pane show">
                      <div class="pricing-wrapper-box">
                        <div class="pricing-wrapper">
                          <div class="pricing-box basic has_fade_anim" data-delay="0.60">
                          ...
                          <div class="pricing-box premium popular has_fade_anim" data-delay="0.75">
                          ...
                          <div class="pricing-box enterprise has_fade_anim" data-delay="0.90">
                            ...
                            <div class="pricing-box basic has_fade_anim">
                              ...
                              <div class="feature-list">
                                <ul>
                                  ...
                                  <li><img src="assets/imgs/icon/check-3.webp" alt="icon image">Automated management
                                  </li>
          ...
          <section class="faq-area section-spacing">
            <div class="container">
              <div class="faq-area-inner">
                <div class="shape-1">
                  <img src="assets/imgs/shape/shape-s-60.webp" alt="shape image">
                </div>
              ...
              <div class="newsletter-area-inner">
                <div class="section-header">
                  ...
                  <div class="form-wrapper has_fade_anim">
                    <form action="pricing.html#" class="subscribe-form">
            ...
            <div class="footer-area-inner">
              ...
              <div class="footer-widget-wrapper">
                ...
                <ul class="footer-nav-list">
                  ...
                  <li><a href="pricing.html#">System Status</a></li>
                </ul>
              </div>
              <div class="footer-widget-wrapper">
                <h2 class="title">Useful Link</h2>
                <ul class="footer-nav-list">
                  <li><a href="pricing.html#">Features</a></li>
                  <li><a href="pricing.html#">Resources</a></li>
                  <li><a href="pricing.html#">Service</a></li>
                  <li><a href="pricing.html#">Team</a></li>
                  <li><a href="pricing.html#">Collection</a></li>
                </ul>
              </div>
              <div class="footer-widget-wrapper">
                <h2 class="title">Product</h2>
                <ul class="footer-nav-list">
                  <li><a href="pricing.html#">Live Chat</a></li>
                  <li><a href="pricing.html#">Jirogram</a></li>
                  <li><a href="pricing.html#">Datasetico</a></li>
                  <li><a href="pricing.html#">Underline</a></li>
                  <li><a href="pricing.html#">Keyword</a></li>
                </ul>
              </div>
            </div>
            <div class="copyright-area-inner">
              <ul class="social-links">
                <li><a href="pricing.html#"><i class="fa-brands fa-facebook-f"></i></a></li>
                <li><a href="pricing.html#"><i class="fa-brands fa-twitter"></i></a></li>
                <li><a href="pricing.html#"><i class="fa-brands fa-instagram"></i></a></li>
                <li><a href="pricing.html#"><i class="fa-brands fa-linkedin"></i></a></li>
              </ul>
        ...
        <div class="form-box-wrapper">
          <div class="login-form-box">
            ...
            <div class="form-wrapper">
              <form action="pricing.html#" class="user-form">
                <div class="input-field">
                ...
                <div class="policy-field">
                  ...
                  <a href="pricing.html#" class="forget-password">Forgot your password?</a>
                </div>
                <button type="submit" class="subscribe-btn wc-btn-primary btn-text-flip"><span
            ...
            <div class="form-wrapper">
              <form action="pricing.html#" class="user-form">
                ...
                <div class="policy-field">
                  ...
                  <label for="d-policy">I agree to sassly <span><a href="pricing.html#">Terms of Service.</a></span></label>
                </div>
                <button type="submit" class="subscribe-btn wc-btn-primary btn-text-flip"><span
